...
TRANSLATIONS = {
    ...
    "nav_reftables":     {"pt": "Tabelas de Referência",       "en": "Reference Tables"},

    # ── Tabelas de Referência / Motor de Regras ─────────────────────────────────
    "ref_title":         {"pt": "Tabelas de Referência e Regras de Negócio",
                          "en": "Reference Tables and Business Rules"},
    "ref_caption":       {"pt": "Carregue a tabela de preços acordada e as regras de cobertura para activar a camada de regras determinísticas.",
                          "en": "Upload the agreed price table and coverage rules to activate the deterministic rules layer."},
    "ref_price_title":   {"pt": "Tabela de Preços Acordada",   "en": "Agreed Price Table"},
    "ref_price_desc":    {"pt": "Procedimento → preço contratado. Permite detectar facturação acima do acordado.",
                          "en": "Procedure → contracted price. Enables detection of billing above the agreed amount."},
    "ref_cov_title":     {"pt": "Regras de Cobertura",         "en": "Coverage Rules"},
    "ref_cov_desc":      {"pt": "Plafonds, limites por sinistro, carências e exclusões por plano.",
                          "en": "Annual caps, per-claim limits, waiting periods and exclusions per plan."},
    "ref_template":      {"pt": "Descarregar template Excel",  "en": "Download Excel template"},
    "ref_upload":        {"pt": "Carregar ficheiro (Excel/CSV)", "en": "Upload file (Excel/CSV)"},
    "ref_loaded":        {"pt": "registos carregados",          "en": "records loaded"},
    "ref_none":          {"pt": "Nenhuma tabela carregada — as regras dependentes ficam inactivas.",
                          "en": "No table loaded — dependent rules remain inactive."},
    "ref_save_ok":       {"pt": "Tabela guardada com sucesso",  "en": "Table saved successfully"},
    "ref_rules_title":   {"pt": "Motor de Regras",              "en": "Rules Engine"},
    "ref_rules_desc":    {"pt": "Active/desactive regras e ajuste os parâmetros. As alterações aplicam-se na próxima análise.",
                          "en": "Enable/disable rules and adjust parameters. Changes apply on the next analysis."},
    "ref_rule_active":   {"pt": "Activa",                       "en": "Active"},
    "ref_rule_inactive": {"pt": "Inactiva",                     "en": "Inactive"},
    "ref_rule_hits":     {"pt": "alertas na última análise",    "en": "alerts in last analysis"},
    "ref_rule_requires": {"pt": "Requer",                       "en": "Requires"},
    "ref_rerun_note":    {"pt": "Re-analise os dados na página Gestão de Dados para aplicar as novas definições.",
                          "en": "Re-run the analysis on the Data Management page to apply the new settings."},
    ...
    # ── Evaluation page ─────────────────────────────────────────────────────────
    "eval_title":        {"pt": "Avaliação da Plataforma",
                          "en": "Platform Evaluation"},
    "eval_caption":      {"pt": "Partilhe a sua experiência para nos ajudar a melhorar continuamente. A sua opinião é essencial.",
                          "en": "Share your experience to help us improve continuously. Your opinion is essential."},
    "eval_tab_form":     {"pt": "📝 Formulário de Avaliação",   "en": "📝 Evaluation Form"},
    "eval_tab_results":  {"pt": "📊 Resultados e Resumo",       "en": "📊 Results & Summary"},
    "eval_info_title":   {"pt": "ℹ️ Sobre esta avaliação",      "en": "ℹ️ About this evaluation"},
    "eval_info_body":    {"pt": "Este formulário destina-se à equipa que utiliza a plataforma no dia-a-dia. As respostas são guardadas anonimamente e usadas para melhorar a ferramenta durante o piloto.",
                          "en": "This form is intended for the team using the platform daily. Responses are stored anonymously and used to improve the tool during the pilot."},
    "eval_section_id":   {"pt": "👤 Identificação (opcional)",  "en": "👤 Identification (optional)"},
    "eval_name":         {"pt": "Nome / Iniciais",              "en": "Name / Initials"},
    "eval_name_ph":      {"pt": "Ex: João S. (opcional)",      "en": "E.g. John S. (optional)"},
    "eval_role":         {"pt": "Cargo / Função",               "en": "Role / Position"},
    "eval_role_opts":    {"pt": ["— Seleccionar —", "Analista de Fraude", "Investigador", "Gestor de Operações", "Director de Risco", "Auditor", "Outro"],
                          "en": ["— Select —", "Fraud Analyst", "Investigator", "Operations Manager", "Risk Director", "Auditor", "Other"]},
    "eval_section_eff":  {"pt": "🎯 Utilidade e Eficácia",     "en": "🎯 Usefulness & Effectiveness"},
    "eval_useful_q":     {"pt": "Quão útil é esta plataforma para o seu trabalho?",
                          "en": "How useful is this platform for your work?"},
    "eval_useful_help":  {"pt": "1 = Pouco útil  |  5 = Extremamente útil",
                          "en": "1 = Not useful  |  5 = Extremely useful"},
    "eval_useful_labels":{"pt": {1:"Pouco útil", 2:"Útil com reservas", 3:"Moderadamente útil", 4:"Muito útil", 5:"Extremamente útil"},
                          "en": {1:"Not useful", 2:"Somewhat useful", 3:"Moderately useful", 4:"Very useful", 5:"Extremely useful"}},
    "eval_selected":     {"pt": "Seleccionado:",               "en": "Selected:"},
    "eval_time_q":       {"pt": "A plataforma poupa tempo na investigação de fraude?",
                          "en": "Does the platform save time in fraud investigation?"},
    "eval_time_opts":    {"pt": ["Sim, poupa significativamente", "Sim, algum tempo", "Neutro", "Não poupa", "Ainda não tenho dados suficientes"],
                          "en": ["Yes, significantly", "Yes, some time", "Neutral", "No savings", "Not enough data yet"]},
    "eval_acc_q":        {"pt": "Quão precisas são as sinalizações de risco?",
                          "en": "How accurate are the risk flags?"},
    "eval_acc_help":     {"pt": "1 = Muitos falsos alarmes  |  5 = Muito precisas",
                          "en": "1 = Many false alarms  |  5 = Very accurate"},
    "eval_acc_labels":   {"pt": {1:"Muitos falsos alarmes", 2:"Imprecisa", 3:"Razoável", 4:"Precisa", 5:"Muito precisa"},
                          "en": {1:"Many false alarms", 2:"Inaccurate", 3:"Reasonable", 4:"Accurate", 5:"Very accurate"}},
    "eval_section_rec":  {"pt": "🔄 Recomendação e Melhorias", "en": "🔄 Recommendation & Improvements"},
    "eval_rec_q":        {"pt": "Recomendaria esta plataforma a outras seguradoras?",
                          "en": "Would you recommend this platform to other insurers?"},
    "eval_rec_opts":     {"pt": ["Sim, definitivamente", "Sim, com algumas melhorias", "Talvez", "Não recomendaria"],
                          "en": ["Yes, definitely", "Yes, with some improvements", "Maybe", "Would not recommend"]},
    "eval_feat_q":       {"pt": "Que funcionalidades gostaria de ver adicionadas?",
                          "en": "What features would you like to see added?"},
    "eval_feat_ph":      {"pt": "Ex: integração com o sistema interno, alertas por email...",
                          "en": "E.g. integration with internal system, email alerts..."},
    "eval_comments_q":   {"pt": "Comentários gerais ou outros aspectos a partilhar",
                          "en": "General comments or other aspects to share"},
    "eval_comments_ph":  {"pt": "Desempenho, interface, facilidade de uso, sugestões...",
                          "en": "Performance, interface, ease of use, suggestions..."},
    "eval_submit":       {"pt": "✅ Submeter Avaliação",        "en": "✅ Submit Evaluation"},
    "eval_success":      {"pt": "✅ Obrigado! A sua avaliação foi guardada com sucesso.",
                          "en": "✅ Thank you! Your evaluation has been saved successfully."},
    "eval_empty":        {"pt": "📭 Ainda não existem avaliações submetidas. Seja o primeiro a avaliar!",
                          "en": "📭 No evaluations submitted yet. Be the first to evaluate!"},
    "eval_kpi_total":    {"pt": "📋 Total de Respostas",        "en": "📋 Total Responses"},
    "eval_kpi_useful":   {"pt": "⭐ Utilidade Média",           "en": "⭐ Avg. Usefulness"},
    "eval_kpi_acc":      {"pt": "🎯 Precisão Média (percepção)","en": "🎯 Avg. Accuracy (perception)"},
    "eval_chart_useful": {"pt": "Distribuição — Utilidade da Plataforma",
                          "en": "Distribution — Platform Usefulness"},
    "eval_chart_acc":    {"pt": "Distribuição — Precisão das Sinalizações",
                          "en": "Distribution — Flag Accuracy"},
    "eval_time_title":   {"pt": "**⏱️ Poupança de Tempo**",    "en": "**⏱️ Time Savings**"},
    "eval_rec_title":    {"pt": "**🔄 Recomendaria a outras seguradoras?**",
                          "en": "**🔄 Would you recommend to other insurers?**"},
    "eval_feat_title":   {"pt": "💡 Funcionalidades Pedidas",  "en": "💡 Requested Features"},
    "eval_comm_title":   {"pt": "💬 Comentários Gerais",       "en": "💬 General Comments"},
    "eval_export_btn":   {"pt": "📥 Exportar Avaliações para CSV",
                          "en": "📥 Export Evaluations to CSV"},
    "eval_score_label":  {"pt": "Pontuação (1-5)",             "en": "Score (1-5)"},
    "eval_responses":    {"pt": "Respostas",                   "en": "Responses"},
    "eval_response_lbl": {"pt": "resposta(s)",                 "en": "response(s)"},
}
